...
if (isset($_POST['PUNDT']) AND !empty($_POST['PUNDT'])) {
 ...
 if ($_POST['PUNDT'] == "Treppe") { shell_exec("./treppe.py"); }
...
<form method="post">
  <table style="width: 75%; text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="2" cellspacing="2">
    <tr>
      ...
      <th style="text-align: center;">TREPPE</th>
    ...
    <tr>
      ...
      <td style="text-align: center;"><button type="submit" name="PUNDT" value="Treppe">Treppe</button></td>
   ...
   <iframe src="http://192.168.20.232:8081/?action=stream" height="800" width="800" frameborder="0"></iframe>
</body>
</html> 
