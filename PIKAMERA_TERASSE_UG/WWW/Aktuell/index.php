...
if (isset($_POST['PUNDT']) AND !empty($_POST['PUNDT'])) {
 ...
 if ($_POST['PUNDT'] == "Links") { shell_exec("sudo /home/pi/pi-pan/links.py"); }
 if ($_POST['PUNDT'] == "Rechts") { shell_exec("sudo /home/pi/pi-pan/rechts.py"); }
 if ($_POST['PUNDT'] == "Oben") { shell_exec("sudo /home/pi/pi-pan/oben.py"); }
 if ($_POST['PUNDT'] == "Unten") { shell_exec("sudo /home/pi/pi-pan/unten.py"); }
}
